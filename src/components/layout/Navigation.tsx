    ...
    <>
      ...
      >
        ...
        <nav className="hidden md:flex items-center gap-1" aria-label="Site sections">
          ...
          <a
            href="#contact"
            className={cn("ml-2.5", buttonVariants({ variant: "solid", radius: "pill", size: "sm" }))}
          >
            Contact
          </a>
        </nav>
        ...
        >
          ...
          <span className={cn(
            "block w-3.5 h-0.5 bg-ink rounded-full self-end transition-all duration-300",
            menuOpen && "opacity-0 -translate-x-2.5",
          )} />
          <span className={cn(
            "block w-5 h-0.5 bg-ink rounded-full transition-all duration-300 origin-center",
            menuOpen && "-rotate-45 -translate-y-1.5",
